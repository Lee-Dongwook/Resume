...
export default function page() {
  return (
    <main className="flex flex-col mt-28 min-h-[100vh] space-y-10">
      <section id="hero">
        <div className="mx-auto w-full max-w-2xl space-y-8">
          <div className="gap-2 flex justify-between">
            <div className="flex-col flex flex-1 space-y-20">
              <BlurFadeText
              ...
              <BlurFade delay={BLUR_FADE_DELAY}>
                <BlurFadeText
                  className="max-w-full md:text-3xl"
                  delay={BLUR_FADE_DELAY}
      ...
      <section id="education">
        <div className="min-h-0 flex items-center justify-center flex-col gap-y-3">
